...
export const config = {
  matcher: ["/((?!_next/static|_next/image|favicon.ico|icon.png|icon-192.png|icon-512.png|apple-icon.png|logo.png|sw.js|manifest.json|offline|auth/callback|api/cron|apresentacao\\.html|eleito|manual).*)"],
};
