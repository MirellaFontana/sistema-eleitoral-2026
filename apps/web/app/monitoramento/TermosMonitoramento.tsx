...
export function TermosMonitoramento({
  ...
  return (
    <div className="space-y-3 rounded border border-neutral-200 p-4">
      <div>
        <h3 className="text-sm font-semibold">O que monitorar</h3>
        <p className="text-xs text-neutral-500">
          Cadastre tudo que a busca automática deve procurar — o próprio candidato, concorrentes,
          ou qualquer outra frase (ex.: "candidato ao governo do Paraná"). A busca roda para todos
          os termos ativos.
        </p>
      </div>
      ...
      <form onSubmit={adicionar} className="flex flex-wrap items-end gap-2">
        <div className="min-w-48 flex-1 space-y-1">
          ...
          <input
            ...
            placeholder='Ex.: "Requião" ou candidato ao governo do Paraná'
