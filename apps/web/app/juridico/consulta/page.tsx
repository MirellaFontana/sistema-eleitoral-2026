...
import { ConsultaJuridica } from "./ConsultaJuridica";
...
export default async function ConsultaJuridicaPage() {
  ...
  return (
    <AppShell campanhaNome={campanha?.nome_candidato ?? undefined} papel={PAPEL_LABEL[eu.papel]}>
      <main className="mx-auto w-full max-w-3xl flex-1 space-y-6 px-4 py-8">
        <div>
          <h1 className="text-lg font-semibold">Consulta jurídica</h1>
          <p className="text-sm text-neutral-500">
            Tire dúvidas sobre legislação eleitoral com auxílio de IA. As respostas usam como
            referência a base de conhecimento da campanha (Código Eleitoral, resoluções do TSE).
          </p>
        </div>
        <ConsultaJuridica />
      </main>
