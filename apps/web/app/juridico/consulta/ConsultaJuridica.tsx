...
export function ConsultaJuridica() {
  ...
  async function enviar(e: React.FormEvent) {
    ...
    setResposta(null);
    try {
      const res = await fetch("/api/juridico/consultar", {
        method: "POST",
    ...
    <div className="space-y-4">
      <form onSubmit={enviar} className="space-y-2">
        <textarea
          ...
          placeholder="Ex.: Candidato pode fazer live em rede social durante o período de propaganda eleitoral gratuita?"
          rows={3}
