...
import { AjudaSistema } from "./AjudaSistema";
  ...
  return (
    <AppShell campanhaNome={campanha?.nome_candidato ?? undefined} papel={PAPEL_LABEL[eu.papel]}>
      <main className="mx-auto w-full max-w-3xl flex-1 space-y-6 px-4 py-8">
        <div>
          <h1 className="text-lg font-semibold">Ajuda do sistema</h1>
          <p className="text-sm text-neutral-500">
            Tire dúvidas sobre como usar o sistema. Pergunte onde encontrar uma funcionalidade,
            como cadastrar informações ou como resolver problemas operacionais.
          </p>
        </div>
        <AjudaSistema />
      </main>
