...
export default async function DemandasObservadasPage() {
  ...
  const [demandasRes, temasRes, territoriosRes, liderancasRes, membrosRes] = await Promise.all([
    supabase
      ...
      .select("id, regiao, cidades, tema, demanda, status, prioridade, responsavel_id, encaminhamento, resposta, origem, prazo, devolutiva, anexos, palavras_chave, created_at")
