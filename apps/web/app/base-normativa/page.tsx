...
import { BaseNormativaClient } from "./BaseNormativaClient";
...
export default async function BaseNormativaPage() {
  ...
  return (
    <AppShell campanhaNome={campanha?.nome_candidato ?? undefined} papel={PAPEL_LABEL[eu.papel]}>
      <BaseNormativaClient
        podeEditar={["coord_campanha", "advogado_responsavel", "assistente_juridico"].includes(eu.papel)}
      />
    </AppShell>
  );
}
