...
const PAPEIS_CRIAM = new Set(["coord_campanha", "candidato", "coord_marketing"]);
const PAPEIS_APROVAM = new Set(["coord_campanha", "candidato"]);
...
export default async function PropostasPage() {
  ...
  return (
    <AppShell campanhaNome={campanha?.nome_candidato ?? undefined} papel={PAPEL_LABEL[eu.papel]}>
      <PropostasClient
        podeCriar={PAPEIS_CRIAM.has(eu.papel)}
        podeAprovar={PAPEIS_APROVAM.has(eu.papel)}
      />
    </AppShell>
  );
}
